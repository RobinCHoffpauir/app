...
- 🎯 Entry points to execute your program using `python -m <app>` or `$ app` with basic CLI argument parsing.
...
Awesome app created by RobinCHoffpauir
...
```bash
git clone https://github.com/RobinCHoffpauir/app app
cd app
make install
```
...
```bash
app create-db   # run once
app populate-db  # run once (optional)
app add-user -u admin -p 1234  # ads a user
app run
```
