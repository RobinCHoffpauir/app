...
original_name="app"
original_urlname="app"
original_description="Awesome app created by RobinCHoffpauir" 
...
then
    ...
    echo "then run 'app' or 'python -m app'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'app' or 'python -m app' or 'poetry run app'"
fi
